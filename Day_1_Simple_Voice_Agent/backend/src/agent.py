...
DEFAULT_CONTENT = [
  ...
  },
  {
    ...
    "summary": "Photosynthesis is the process by which green plants, algae, and some bacteria convert sunlight into chemical energy using chlorophyll.",
    "sample_question": "Which organelle is responsible for photosynthesis in plant cells?"
    },
    {
    "id": "dna_structure",
    "title": "DNA Structure",
    "summary": "DNA is a double-helical molecule that carries genetic information in the form of sequences of nucleotides.",
    "sample_question": "What are the four nitrogenous bases found in DNA?"
    },
    {
    "id": "protein_synthesis",
    "title": "Protein Synthesis",
    "summary": "Protein synthesis involves transcription of DNA into mRNA and translation of mRNA into proteins by ribosomes.",
    "sample_question": "Which molecule carries genetic instructions from the nucleus to the ribosome?"
    }
]
