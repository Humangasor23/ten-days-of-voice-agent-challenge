...
def seed_database():
    ...
    if cur.fetchone()[0] == 0:
        sample_data = [
            ...
            (
                "Sujal", "55673", "8842",
                "Luxury Electronics Store", "$3,870.00", "1:12 AM CST", "bestbuy-global.com",
                "pending_review", "Automated flag: Sudden spike in purchase amount."
            ),
            (
                "David", "33221", "6677",
                "Peer-to-Peer Wallet", "$980.00", "11:59 PM EST", "crypto-wallet-transfer",
                "pending_review", "Automated flag: Rapid consecutive transfers."
            ),
            (
                "Priya", "88990", "3131",
                "Online Gaming Marketplace", "$620.00", "2:05 AM IST", "gamehub.pro",
                "pending_review", "Automated flag: New merchant + high amount combination."
            ),
            (
                "John", "12345", "4242",
            ...
            (
                ...
                "Kevin", "12004", "2211",
                "Random Gift Card Seller", "$300.00", "5:22 AM MST", "giftquick.io",
                "pending_review", "Automated flag: Gift card purchases flagged for fraud."
            ),
            (
                "Emily", "44789", "5522",
                "Unknown Retail Store", "$199.00", "12:14 AM EST", "buy-fast.shop",
                "pending_review", "Automated flag: Merchant domain recently associated with scams."
            ),
            (
                "Rohan", "67332", "7717",
                "Crypto Mining Service", "$1,725.00", "4:48 AM IST", "hashmine.pro",
                "pending_review", "Automated flag: Transaction category mismatch with user profile."
            )
...
class FraudAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            You are 'Alex', a Fraud Detection Specialist at ICFC Bank.
