...
# Default FAQ data for "Mr. Sujal Store"
DEFAULT_FAQ = [
    {
        "question": "What do you sell?",
        "answer": "We offer premium courses on Cloud Computing, Google Cloud Arcade, Ethical Hacking, and Voice AI Agent Development."
    },
    {
        "question": "How much does the CEH course cost?",
        "answer": "Our 'Professional CEH Mastery' course is priced at $499. It covers Nmap, Wireshark, Nessus, Burp Suite, and modern AI-powered penetration testing tools and techniques."
    },
    {
        "question": "Do you offer free content?",
        "answer": "Yes, absolutely! Sujal releases free weekly tutorials on YouTube covering cybersecurity, cloud fundamentals, and hands-on AI agent development. Paid courses include deep dives, structured roadmaps, and certification support."
    },
    {
        "question": "Do you provide corporate consulting?",
        "answer": "Yes. We offer corporate consulting services focused on strengthening security posture, cloud infrastructure optimization, and deploying voice-based AI agents. Pricing depends on the project scope and requirements."
    },
    {
        "question": "Do you provide one-on-one mentorship?",
        "answer": "Yes, limited mentorship slots are available each month for students and professionals looking to upskill in cybersecurity, cloud, or AI voice agent development."
    },
    {
        "question": "What payment methods do you accept?",
        "answer": "We accept major credit/debit cards, UPI, PayPal, and bank transfers. EMI options are available for select courses."
    },
    {
        "question": "Do your courses include hands-on labs?",
        "answer": "Yes. All technical courses include real-world labs, guided projects, and practical tasks based on industry scenarios."
    }
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Mr. Sujal Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Mr. Sujal and email you." (Don't hallucinate prices).
            """,
