    ...
    <div className="relative min-h-screen w-full overflow-hidden font-sans bg-black">
      ...
      >
        <div className="whitespace-pre-line text-transparent bg-clip-text bg-gradient-to-b from-white to-white/10">
          ...
          <div className="text-white/60 text-base md:text-lg mt-2 tracking-normal font-normal leading-snug max-w-full md:max-w-[30rem]">
            A playful voice-first improv host - get a quick scene, perform out loud, and receive live reactions.
          </div>
        </div>
      </div>
